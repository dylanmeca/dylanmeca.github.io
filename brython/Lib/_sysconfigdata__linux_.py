...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'arm-linux-androideabi-clang -shared '
              ...
              '-L/home/builder/.termux-build/_cache/android5-r20-api-21-v2/sysroot/usr/lib '
 ...
 'CFLAGS': '-mfloat-abi=softfp -mfpu=vfpv3-d16 -Wno-unused-result '
           ...
           '-march=armv7-a -mfpu=neon -mfloat-abi=softfp -mthumb -Oz '
           '-fstack-protector-strong  -march=armv7-a -mfpu=neon '
           '-mfloat-abi=softfp -mthumb -Oz -fstack-protector-strong',
 'CFLAGSFORSHARED': '-fPIC',
 'CFLAGS_ALIASING': '-fno-strict-aliasing',
 'CFLAGS_NODIST': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-march=armv7-a -mfpu=neon -mfloat-abi=softfp -mthumb -Oz '
 ...
 'CONFIGURE_CPPFLAGS': '-I/data/data/com.termux/files/usr/include '
                       '-I/home/builder/.termux-build/_cache/android5-r20-api-21-v2/sysroot/usr/include',
 'CONFIGURE_LDFLAGS': '-L/data/data/com.termux/files/usr/lib -march=armv7-a '
                      '-Wl,-z,relro,-z,now -landroid-support '
                      '-L/home/builder/.termux-build/_cache/android5-r20-api-21-v2/sysroot/usr/lib '
                      '-march=armv7-a -Wl,--fix-cortex-a8',
 ...
 'CONFIG_ARGS': "'--disable-dependency-tracking' "
                ...
                "'ac_cv_little_endian_double=yes' '--disable-nls' "
                "'--enable-shared' '--enable-static' "
                "'--libexecdir=/data/data/com.termux/files/usr/libexec' "
                "'build_alias=x86_64-pc-linux-gnu' "
                "'host_alias=arm-linux-androideabi' "
                "'CC=arm-linux-androideabi-clang' 'CFLAGS= -march=armv7-a "
                '-mfpu=neon -mfloat-abi=softfp -mthumb -Oz '
                "-fstack-protector-strong' "
                "'LDFLAGS=-L/data/data/com.termux/files/usr/lib -march=armv7-a "
                '-Wl,-z,relro,-z,now -landroid-support '
                "-L/home/builder/.termux-build/_cache/android5-r20-api-21-v2/sysroot/usr/lib' "
                "'CPPFLAGS=-I/data/data/com.termux/files/usr/include "
                "-I/home/builder/.termux-build/_cache/android5-r20-api-21-v2/sysroot/usr/include' "
                "'CPP=arm-linux-androideabi-cpp' "
                "'PKG_CONFIG=/home/builder/.termux-build/_cache/android5-r20-api-21-v2/bin/arm-linux-androideabi-pkg-config' "
 ...
 'LLVM_PROF_MERGER': '/home/builder/.termux-build/_cache/android5-r20-api-21-v2/bin/llvm-profdata '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-mfloat-abi=softfp -mfpu=vfpv3-d16 '
                             ...
                             '-mthumb -Oz -fstack-protector-strong  '
                             '-march=armv7-a -mfpu=neon -mfloat-abi=softfp '
                             '-mthumb -Oz -fstack-protector-strong -std=c99 '
 ...
 'PY_CORE_CFLAGS': '-mfloat-abi=softfp -mfpu=vfpv3-d16 -Wno-unused-result '
                   ...
                   '-Oz -fstack-protector-strong  -march=armv7-a -mfpu=neon '
                   '-mfloat-abi=softfp -mthumb -Oz -fstack-protector-strong '
                   ...
                   '-I/home/builder/.termux-build/_cache/android5-r20-api-21-v2/sysroot/usr/include '
                   '-fPIC -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/data/data/com.termux/files/usr/lib -march=armv7-a '
                    '-Wl,-z,relro,-z,now -landroid-support '
                    '-L/home/builder/.termux-build/_cache/android5-r20-api-21-v2/sysroot/usr/lib '
                    '-march=armv7-a -Wl,--fix-cortex-a8 '
                    '-L/data/data/com.termux/files/usr/lib -march=armv7-a '
 ...
 'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. '
                ...
                '-I/home/builder/.termux-build/_cache/android5-r20-api-21-v2/sysroot/usr/include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/data/data/com.termux/files/usr/lib -march=armv7-a '
               '-Wl,-z,relro,-z,now -landroid-support '
               '-L/home/builder/.termux-build/_cache/android5-r20-api-21-v2/sysroot/usr/lib '
               '-march=armv7-a -Wl,--fix-cortex-a8 '
               '-L/data/data/com.termux/files/usr/lib -march=armv7-a '
 ...
 'PY_STDMODULE_CFLAGS': '-mfloat-abi=softfp -mfpu=vfpv3-d16 -Wno-unused-result '
                        ...
                        '-O3 -Wall -march=armv7-a -mfpu=neon '
                        '-mfloat-abi=softfp -mthumb -Oz '
                        '-fstack-protector-strong  -march=armv7-a -mfpu=neon '
                        '-mfloat-abi=softfp -mthumb -Oz '
                        '-fstack-protector-strong -std=c99 -Wextra '
